...
lemma TendstoUniformlyOn.tendsto_circle_integral (hr : 0 < r)
  ...
  case pos =>
    ...
    convert! circleIntegral.norm_integral_lt_of_norm_le_const_of_lt hr (h'.sub f_cont) (λ z hz => (h z hz).le) this using 1
    exact (mul_inv_cancel_left₀ twopir_ne_zero ε).symm
