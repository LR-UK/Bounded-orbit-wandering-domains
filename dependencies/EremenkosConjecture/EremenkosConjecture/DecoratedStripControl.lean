...
This joins the boundary construction to the approximation interface. The
...
theorem exists_strip_map_with_uniform_control
    ...
    (hJordan : TauCeti.IsJordanCurve (frontier (FunctionTheory.exponentialImage U)))
  ...
  obtain ⟨φ, ρ, hφd, hφbij, hφ0, hOd, hOv, -⟩ :=
    FunctionTheory.exists_normalized_strip_map_of_jordan_exponential_image
      hUo hUc hUS hleft htail hJordan hz₀
